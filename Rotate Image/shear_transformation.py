...
image = np.array(Image.open("sun.jpg"))             # Load the image
...
pil_img.save("Shear_image.png")
shear_img = cv2.imread("Shear_image.png")
cv2.imshow("Shear Transformation", shear_img)
cv2.waitKey(0)